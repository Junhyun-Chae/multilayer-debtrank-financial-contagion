...
def animate_risk_propagation_debtrank(weight_matrices, countries, time_periods, default_probabilities_df, output_file):
    ...
    cbar.set_label('DebtRank (Default Risk)', fontsize=14)
    arrow_legend = (
    ...
    ani = animation.FuncAnimation(fig, update, frames=total_steps, interval=1000, repeat=False, blit=False)
